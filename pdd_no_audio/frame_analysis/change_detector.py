# pdd_no_audio/frame_analysis/change_detector.py
...
from pdd_no_audio.frame_analysis.ocr_engine import compute_text_diff
...
def compute_pixel_diff(
    ...
    for contour in contours:
        ...
        if area > min_area:
            ...
            changed_regions.append({"x": x, "y": y, "w": w, "h": h, "area": area})
